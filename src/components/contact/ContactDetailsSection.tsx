        ...
        <div data-animate="fade-up">
          ...
          <form onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
            <input
              aria-label="Name"
              placeholder="Name"
              className="h-[58px] border-b border-[#CD1417] bg-transparent text-[21px] leading-none outline-none transition placeholder:text-[#8E8E8E] focus:border-civilia-red"
            />
            ...
            <textarea
              aria-label="Message"
              placeholder="Message"
              className="min-h-[130px] resize-none border-b border-[#CD1417] bg-transparent pt-4 text-2xl leading-none outline-none transition placeholder:text-[#8E8E8E] focus:border-civilia-red"
            />
          ...
          {contactCards.map((card) => {
            ...
            return (
              <article
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #FFFDFA 0%, ##C87D07 50%, #FFFDFA 100%)",
                }}
              >
                <div className="w-[233px]">
                  <div className="flex items-center gap-4">
                    <Icon
                      className="h-6 w-6 text-civilia-red"
                      aria-hidden="true"
                    />
                    <h3 className="text-[29px] font-medium leading-none text-[#3d3d3d]">
                      {card.title}
                    </h3>
                  </div>
                  ...
                  <p className="mt-3 text-[18px] leading-[1.2] text-civilia-red whitespace-nowrap">
                    {card.value}
                  </p>
                </div>
              </article>
